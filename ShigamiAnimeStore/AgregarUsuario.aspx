                ...
                <div class="panel panel-rojo">
                    ...
                    <div class="panel-cuerpo">
                        ...
                        <div class="fila">
                            ...
                            <div class="label">
                                <asp:Label ID="lbl_NombredeUsuario" runat="server">Nombre de Usuario</asp:Label></div>
                            </div>
                            <div class="col-md-4 col-md-offset-1">
                        ...
                        <br />
                            ...
                            <div class="col-md-4 col-md-offset-1">
                            <div class="label">
                                <asp:Label ID="lbl_password" runat="server">Contraseña</asp:Label></div>
                            </div>
                            <div class="col-md-4 col-md-offset-1">
                        ...
                        <br />
                            ...
                            <div class="col-md-4 col-md-offset-1">
                            <div class="label">
                                <asp:Label ID="lbl_repetirPassword" runat="server">Repetir Contraseña</asp:Label></div>
                            </div>
                            <div class="col-md-4 col-md-offset-1">
                            ...
                            <div class="label">
                                <asp:Label ID="lbl_NuevoPassword" runat="server">Resetear Contraseña</asp:Label></div>
                            </div>
                            <div class="col-md-4 col-md-offset-1">
                        ...
                        <br />
                            ...
                            <div class="col-md-4 col-md-offset-1">
                            <div class="label">
                                <asp:Label ID="lbl_documento" runat="server">N° de Documento</asp:Label></div>
                            </div>
                            <div class="col-md-4 col-md-offset-1">
                            ...
                            <div class="col-md-4 col-md-offset-1">
                            <div class="label">
                                <asp:Label ID="lbl_perfil" runat="server">Perfil</asp:Label></div>
                            </div>
                            <div class="col-md-4 col-md-offset-1">
