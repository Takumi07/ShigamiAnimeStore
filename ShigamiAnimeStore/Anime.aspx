<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Maestra.Master" CodeBehind="Anime.aspx.vb" Inherits="ShigamiAnimeStore.Anime"  EnableEventValidation="false"%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoPagina" runat="server">
       <div class="panel panel-rojo">
        <div class="panel-cabecera">
            <asp:Label ID="lbl_Manga" runat="server" Text="Anime"></asp:Label>
        </div>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <asp:GridView ID="GridView1" CssClass="Grid-rojo" runat="server" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="N_DVD" HeaderText="Nro. DVD" />
