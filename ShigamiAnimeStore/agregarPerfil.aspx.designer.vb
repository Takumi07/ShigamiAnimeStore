...
Partial Public Class agregarPerfil
    ...
    '''<summary>
    '''Control cab_agregarPerfil.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents cab_agregarPerfil As Global.System.Web.UI.WebControls.Label
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents modificar As Global.System.Web.UI.HtmlControls.HtmlGenericControl
