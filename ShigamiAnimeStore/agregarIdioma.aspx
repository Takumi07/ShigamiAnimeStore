        ...
        <div class="fila">
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-rojo">
                    <div class="panel-cabecera"><asp:Label ID="cab_AgregarIdioma" runat="server">Agregar Idioma</asp:Label></div>
                    <div class="panel-cuerpo">
                        ...
                        <div class="fila">
                            <div class="col-md-5 col-md-offset-1">
                                <asp:Label ID="lbl_cultura" runat="server" CssClass="label">Cultura</asp:Label></div>
                            <div class="col-md-4 col-md-offset-1">
